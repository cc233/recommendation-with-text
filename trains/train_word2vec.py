...
citeulike_a_path='/home/chenchen/data/ctrsr_datasets/citeulike-a/raw-data.csv'
...
model_path='/home/chenchen/CRHNN/recommendation0/data/citeulike-a_word2vec_model_128'
...
def train():
    ...
    model=Word2Vec(doc,size=128,workers=4)
    a=model['computer']
    print a.shape
